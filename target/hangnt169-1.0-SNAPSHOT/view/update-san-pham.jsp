    ...
    <section>
        <form action="/san-pham/update?id=${lopHoc.id}" method="post">
            ...
            <div class="row mt-4">
                <div class="col-6">
                    <label>Loại </label>
                    <input type="text" class="form-control" name="loai" value="${lopHoc.loai}"/>
                </div>
                <div class="col-6">
                    <label>Số lượng tồn</label>
                    <input type="text" class="form-control" name="slt" value="${lopHoc.soLuongTon}"/>
            ...
            <div class="row mt-4">
                <div class="col-6">
                    <label>Giá</label>
                    <input type="text" class="form-control" name="gia" value="${lopHoc.gia}"/>
                </div>
                <div class="col-6">
                    <label>Miêu tả</label>
                    <input type="text" class="form-control" name="mieuTa" value="${lopHoc.mieuTa}"/>
                </div>
            </div>
